                ...
                <td class="text-center">
                  <?php if ($contact->avatar): ?>
                    <img src="/<?= html_escape($contact->avatar) ?>" alt="Avatar"
                      style="width: 60px; height: 60px;" class="rounded d-block mx-auto">
                  <?php else: ?>
                    <span>No avatar</span>
                  <?php endif ?>
                </td>
                <td class="d-flex justify-content-center">
                  <a href="/edit.php?id=<?= $contact->id ?>" class="btn btn-xs btn-warning ms-1">
                    <i class="fa fa-pencil" alt="Edit"></i> Edit
                  </a>
                  <form class="ms-1" action="/delete.php" method="POST">
                    <input type="hidden" name="id" value="<?= $contact->id ?>">
                    <button type="submit" class="btn btn-xs btn-danger" name="delete-contact">
                      <i class="fa fa-trash" alt="Delete"></i> Delete
                    </button>
                  </form>
                </td>
              </tr>
